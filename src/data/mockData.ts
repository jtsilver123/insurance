...
export const mockProspects: Prospect[] = [
  {
    ...
    revenue: 2500000,
    status: 'quotes',
    portalLink: 'https://portal.insurancetech.com/p/abc123',
  ...
  },
  {
    ...
    revenue: 5000000,
    status: 'form',
    portalLink: 'https://portal.insurancetech.com/p/def456',
  ...
  },
  {
    ...
    status: 'docs',
    portalLink: 'https://portal.insurancetech.com/p/ghi789',
...
export const mockActivities: Activity[] = [
  ...
  },
  {
    ...
    prospectId: '1',
    type: 'form',
    description: 'Smart form completed',
  ...
  },
  {
    ...
    prospectId: '1',
    type: 'quote',
    description: 'Quote received from Liberty Mutual',
...
const mockCarriers: Carrier[] = [
  {
    ...
    contact: {
      email: 'underwriting@libertymutual.com',
      name: 'Jane Doe'
    }
  },
  {
    ...
    name: 'Travelers',
    appetite: {
      naicsCodes: ['541511', '221118'],
      revenueRange: [500000, 25000000],
      states: ['CA', 'NY', 'TX', 'FL', 'IL']
    },
    contact: {
      email: 'submissions@travelers.com',
      name: 'Bob Wilson'
    }
  }
];
...
import { Filter, Search, MoreVertical, FileText, X, User, Building, Baseline as Timeline, Globe, UserCheck, Sparkles, Star, Upload, Eye, Download, Mail, Phone, MessageSquare, ExternalLink, Star as StarIcon } from 'lucide-react';
